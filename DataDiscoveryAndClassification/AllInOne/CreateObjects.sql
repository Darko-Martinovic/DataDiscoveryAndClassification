...
IF NOT EXISTS ( SELECT  *
                FROM    sys.schemas
                WHERE   name = N'DC' ) 
    EXEC('CREATE SCHEMA [DC] AUTHORIZATION [dbo]');
...
GO
ALTER TABLE [DC].[InformationType] CHECK CONSTRAINT [FK_InformationType_SensitiveName]
GO
...
GO
ALTER TABLE [DC].[KeyWords] CHECK CONSTRAINT [FK_KeyWords_InformationType]
GO
--== Create views
